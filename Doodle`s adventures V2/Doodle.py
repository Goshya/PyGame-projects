...
true_screen = sc.get_size()
print(true_screen)
true_window = [int(true_screen[0] // 3), int(true_screen[1] // 1.125)]
print(true_window)
display = pygame.Surface(true_window)
player_rect = pygame.Rect(307, int(true_window[1] * 0.9375), 26, 50)
TILE = 32
...
# Game settings
screen_res = [[640, 960], [1200, 1000], [1366, 768], [1680, 1050], [1920, 1080]]
cur_setting = 0
cur_res = 0
...
def settings():
    ...
    while in_settings:
        ...
        sc.blit(pygame.transform.scale(display, true_window),
                ((true_screen[0] - true_window[0]) // 2, (true_screen[1] - true_window[1]) // 2))
        #sc.blit(display, ((true_screen[0] - true_window[0]) // 2, (true_screen[1] - true_window[1]) // 2))
...
while game:
    ...
    true_scroll += (player_rect.y - true_scroll - true_window[0]) // 20
    ...
    if player_rect.y - scroll >= window[1]:
        ...
        coins = 0
        game_end()
    sc.blit(pygame.transform.scale(display, true_window), ((true_screen[0] - true_window[0]) // 2, (true_screen[1] - true_window[1]) // 2))
    #sc.blit(display, ((true_screen[0] - true_window[0]) // 2, (true_screen[1] - true_window[1]) // 2))
